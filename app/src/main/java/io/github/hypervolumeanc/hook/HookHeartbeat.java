...
final class HookHeartbeat {
    static final String ACTION_HOOK_ALIVE = "io.github.hypervolumeanc.action.HOOK_ALIVE";
    static final String ACTION_PING = "io.github.hypervolumeanc.action.PING";
    static final String ACTION_PONG = "io.github.hypervolumeanc.action.PONG";
    static final String EXTRA_PROCESS = "process";
    static final String EXTRA_NONCE = "nonce";
    static final String MODULE_PACKAGE = "io.github.hypervolumeanc";
