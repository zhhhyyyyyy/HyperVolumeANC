...
public final class ModuleConfigProvider extends ContentProvider {
    public static final String AUTHORITY = "io.github.zhhhyyyyyy.hypervolumeanc.config";
    public static final String ACTION_CONFIG_CHANGED = "io.github.zhhhyyyyyy.hypervolumeanc.action.CONFIG_CHANGED";
